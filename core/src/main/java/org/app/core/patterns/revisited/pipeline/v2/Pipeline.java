package org.app.core.patterns.revisited.pipeline.v2;
...
public class Pipeline<T> {
    ...
    // Private constructor for an empty pipeline
    private Pipeline() {
        this.source = Collections.emptyList();
        this.isEmpty = true;
    }

    // Private constructor for a non-empty pipeline
    ...
    /**
     * Find the first element or return empty optional
     */
    ...
    /**
     * Find the first element or return a default value
     */
    ...
    /**
     * Find the first element or throw exception
     */
