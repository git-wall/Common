...
public class JdbcUtils {
    ...
    public static PreparedStatement setTimeout(PreparedStatement ps, int timeoutSeconds) throws SQLException {
    ...
    public static class RetryConfig {
        ...
        private Set<String> retryableSQLStates = new HashSet<>(Arrays.asList(
